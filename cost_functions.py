...
TrajectoryData = namedtuple("TrajectoryData", ['intended_lane',
                                               'final_lane',
...
def get_helper_data(vehicle, trajectory, predictions):
    ...
    distance_to_goal: the distance of the vehicle to the goal measured in s.
    ...
    """
    # trajectory covers 2 time steps
    last = trajectory[1]
